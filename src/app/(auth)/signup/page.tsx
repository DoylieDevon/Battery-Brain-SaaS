      ...
      <div className="flex-1 flex items-center justify-center px-5 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-[#7C8A83] mt-1.5">Your home battery, on autopilot.</p>
          </div>
                ...
                <form onSubmit={sendPin} className="space-y-4">
                  <div>
                    ...
                    <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                      ...
                      className="w-full bg-[#F4F8F5] border border-[#E5EDE8] rounded-2xl px-4 py-3.5 text-sm text-[#0E2A24] placeholder:text-[#B6C2BB] outline-none focus:border-[#18C172] transition-colors" />
                  </div>
